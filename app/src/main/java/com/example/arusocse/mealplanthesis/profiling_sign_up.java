...
public class profiling_sign_up extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.profiling_sign_up);
    ...
    public void signUpSubmit() {
        ...
        if(errorMessage.isEmpty()){
            ...
            Intent i = new Intent(profiling_sign_up.this, sign_up_goal.class);
            startActivity(i);
            finish();
        }
        else {
